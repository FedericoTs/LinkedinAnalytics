  ...
  const features: Feature[] = [
    {
      ...
      description:
        "Generate professional posts, articles, and infographics using our AI assistant with customizable templates.",
      icon: <FileText className="h-10 w-10 text-black" />,
    },
    {
      title: "Performance Analytics",
      description:
        "Interactive charts displaying post engagement metrics, audience demographics, and optimal posting times.",
      icon: <BarChart2 className="h-10 w-10 text-black" />,
    },
    {
      title: "Network Visualization",
      description:
        "Neo4j-powered graph view showing connection clusters, influential nodes, and pathways between professionals.",
      icon: <Network className="h-10 w-10 text-black" />,
    },
    {
      title: "Relationship Insights",
      description:
        "Tools to identify strategic connection opportunities and measure network growth over time.",
  ...
  const testimonials: Testimonial[] = [
    {
      ...
      company: "TechFlow",
      content:
        "The AI content creation tools have saved me hours each week. My engagement rates have increased by 45% since I started using the platform.",
      avatar: "sarah",
    },
    {
      id: 2,
      ...
      content:
        "The network visualization feature helped me identify key influencers in my industry that I was missing. I've made 5 strategic connections that led to new business opportunities.",
      avatar: "michael",
    },
    {
      id: 3,
      ...
      company: "CareerBoost",
      content:
        "I recommend this platform to all my clients. The relationship insights have helped them build more meaningful professional networks and advance their careers faster.",
      avatar: "aisha",
    },
  ];
      ...
      <header className="fixed top-0 z-50 w-full border-b border-gray-200 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60">
        <div className="container flex h-16 items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            >
              <BarChart2 className="h-6 w-6 mr-2 text-black" />
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
              <div className="lg:w-1/2 space-y-8">
                ...
                <p className="text-lg md:text-xl text-gray-600">
                  A comprehensive analytics dashboard that helps professionals
                  optimize their LinkedIn presence through AI-powered content
                    ...
                    <div className="flex flex-col space-y-4">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          ...
                          <span className="font-medium">Post Performance</span>
                        </div>
                      ...
                      <div className="flex items-center justify-between mt-4">
                        ...
                        <span className="font-medium">Tuesdays, 9-10 AM</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="container px-4 mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4 text-black">
                Comprehensive LinkedIn Analytics Suite
              </h2>
              <p className="text-gray-600 max-w-[700px] mx-auto">
                Our platform provides powerful tools to analyze your LinkedIn
                presence, create engaging content, and build strategic
                connections to accelerate your professional growth.
              </p>
            </div>
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="container px-4 mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-600 max-w-[700px] mx-auto">
                Whether you're just starting out or managing a large
                professional network, we have a plan that fits your needs. All
                plans include our core analytics features with flexible scaling
                options.
              </p>
            </div>
          ...
          <div className="container px-4 mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-600 max-w-[700px] mx-auto">
                ...
                presence and career opportunities using our platform.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-gray-100 to-white rounded-3xl p-8 md:p-12 shadow-xl border border-gray-200">
              <div className="max-w-3xl mx-auto text-center">
                ...
                <p className="text-lg md:text-xl mb-8 text-gray-600">
                  Join thousands of professionals who are leveraging AI-powered
                  analytics to grow their network and advance their careers.
                </p>
        ...
        <div className="container px-4 mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              >
                <BarChart2 className="h-5 w-5 mr-2 text-black" />
                LinkedIn Analytics Platform
              </Link>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-600">
              © {new Date().getFullYear()} LinkedIn Analytics Platform. All
              rights reserved.
            </p>
